...
app.use(cors({ credentials: true, origin: ['http://localhost:5173', 'http://192.168.0.85:5173', 'http://192.168.0.138', "http://zimmermatic", "http://recipeshub.de"] }));
app.use(function (req, res, next) {
  res.header("Access-Control-Allow-Origin", 'http://localhost:5173', 'http://192.168.0.85:5173', "http://192.168.0.138", "http://zimmermatic", "http://recipeshub.de");
